...
LassoRegression::LassoRegression(double alpha) {
	if (alpha < 0) {
...
void LassoRegression::fit(std::vector<std::vector<double>> x, std::vector<double> y, double learningRate, bool verbose) {
	int epochs = 1000000;
...
std::vector<double> LassoRegression::gradient(std::vector<std::vector<double>> x, std::vector<double> y) {
	std::vector<double> grad;
...
double LassoRegression::loss(std::vector<std::vector<double>> x, std::vector<double> y) {
	double res = 0;
...
std::vector<double> LassoRegression::predict(std::vector<std::vector<double>> x) {
